      ...
      <table class="mx-auto border-collapse">
            ...
            >
              ...
              >
                ...
                <span v-if="header.sortable" class="ml-1">
                  <span
                    v-if="sortBy === header.value && sortDirection === 'ASC'"
                  >
                    ▲
                  </span>
                  <span
        ...
        <tbody class="overflow-hidden">
          <tr
            ...
            :key="index"
            class="focus:outline-none focus:ring-1 focus:ring-purple-300 focus:border-purple-300 border border-gray-200 text-center hover:shadow-[0_2px_15px_3px_rgba(0,0,0,0.07),0_10px_20px_2px_rgba(0,0,0,0.04)] h-16"
          >
            <td>{{ user.userName }}</td>
            <td>{{ user.fullName }}</td>
            <td>{{ user.dob }}</td>
